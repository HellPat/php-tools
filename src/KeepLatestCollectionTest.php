...
{
    static function data_sets(): iterable
    {
        yield 'empty' => [
            [],
        ...
        yield 'strange keys' => [
            ...
            KeepLatestCollection::max(3)
                ->appendMany(['1' => 'one', '7' => 'two'])
                ->appendMany(['3' => 'three', '4' => 'four'])
        ];
    }

    #[DataProvider('data_sets')]
    function test_expectations(mixed $expectation, KeepLatestCollection $collection)
    {
